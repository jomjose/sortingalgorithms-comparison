        ...
        if (j < len - 1) {
            ...
            if (i < len) {
                ...
                if (dataset[i].num < dataset[iMin].num) {
                    if (iMin !== j) dataset[iMin].state = states.
                    default;
